        ...
        <div className='DAT_Alarm_Body_ND'>
          <div className='DAT_Alarm_Body_ND_Header'>
            ...
            <div className='DAT_Alarm_Body_ND_Header_Button'>
              <button className='DAT_Alarm_Body_ND_Header_Button_Pdf'>{lang.formatMessage({ id: "alarm_report_pdf" })}</button>
              <button className='DAT_Alarm_Body_ND_Header_Button_Excel'>{lang.formatMessage({ id: "alarm_report_excel" })}</button>
            </div>
          </div>
