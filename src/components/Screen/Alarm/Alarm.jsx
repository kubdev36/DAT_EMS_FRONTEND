...
// import { socket } from "../../../App"; // [MOCKED] Kết nối Socket.IO thời gian thực bị comment lại, dùng mock data mô phỏng thay thế
import { MOCK_BESS_DATA, generateMockBessUpdate } from "../../Data/Data";
...
export default function Alarm() {
  ...
  useEffect(() => {
    // [MOCKED] API thật bị comment lại, dùng MOCK_BESS_DATA thay thế
    // (async () => {
    ...
    setDataInf(MOCK_BESS_DATA);
    setStep(1);
    console.log("[MOCK] readBess data:", MOCK_BESS_DATA);
  }, []);

  useEffect(() => {
    if (!step) return;
    // [MOCKED] Kết nối Socket.IO thật bị comment lại, dùng interval mô phỏng dữ liệu realtime thay thế
