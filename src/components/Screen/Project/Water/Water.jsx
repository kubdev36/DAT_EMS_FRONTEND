  ...
  return (
    <div className={`DAT_Water_Branch ${isRoot ? "DAT_Water_Branch_Root" : ""}`}>
      <div className="DAT_Water_Branch_NodeWrapper">
        {!isRoot && <div className="DAT_Water_Branch_NodeWrapper_ChildLabel">{node.data.title}</div>}

        <div className="DAT_Water_Branch_NodeWrapper_Card" onClick={() => navigate(`/water/${node.id}`)}>
          {isRoot ? (
    ...
    <div className="DAT_Water">
      ...
      {modal && (
        <div className="DAT_Water_ModalOverlay" onClick={closeModal}>
          <div className="DAT_Water_ModalOverlay_Modal" onClick={(e) => e.stopPropagation()}>
